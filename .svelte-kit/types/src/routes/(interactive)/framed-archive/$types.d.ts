...
type RouteParams = {  };
type RouteId = '/(interactive)/framed-archive';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(interactive)/framed-archive/+page.server.js').load>>>>>>;
