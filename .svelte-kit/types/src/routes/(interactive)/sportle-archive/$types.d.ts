...
type RouteParams = {  };
type RouteId = '/(interactive)/sportle-archive';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(interactive)/sportle-archive/+page.server.js').load>>>>>>;
