...
type RouteParams = {  };
type RouteId = '/(interactive)/sportle-solver';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(interactive)/sportle-solver/+page.server.js').load>>>>>>;
