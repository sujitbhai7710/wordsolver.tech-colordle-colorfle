...
type RouteParams = {  };
type RouteId = '/(interactive)/sportle-answer-today';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(interactive)/sportle-answer-today/+page.server.js').load>>>>>>;
