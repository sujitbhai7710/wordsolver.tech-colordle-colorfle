...
type RouteParams = {  };
type RouteId = '/(interactive)/onepiedle-solver';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(interactive)/onepiedle-solver/+page.server.js').load>>>>>>;
